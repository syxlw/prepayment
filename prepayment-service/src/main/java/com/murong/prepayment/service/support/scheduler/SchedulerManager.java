 ...
 */
package com.murong.prepayment.service.support.scheduler;

import com.murong.prepayment.common.dao.domain.TaskSchedule;
import com.murong.prepayment.common.dao.domain.TaskSchedule.JobType;
import com.murong.prepayment.common.util.LogUtil;
import com.murong.prepayment.service.support.scheduler.job.DefaultJob;
import com.murong.prepayment.service.support.scheduler.job.StatefulJob;
 ...
 * @author lw.xu
 * @version $Id: SchedulerManager.java, v 0.1 2017年8月24日 下午7:27:41 lw.xu Exp $
 */
