 ...
 */
package com.murong.prepayment.service.datasource;
 ...
 * @author lw.xu
 * @version $Id: DecryptDruidDataSource.java, v 0.1 2017年9月4日 下午5:10:57 lw.xu Exp $
 */
public class DecryptDruidDataSource extends DruidDataSource {
    ...
    public void setPassword(String password) {
        try {
            ...
            throw new RuntimeException("解密数据库密码出错", e);
        }
