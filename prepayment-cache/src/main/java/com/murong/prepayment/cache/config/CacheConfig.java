 ...
 */
package com.murong.prepayment.cache.config;
 ...
 * 缓存配置
 * @author lw.xu
 * @version $Id: CacheConfig.java, v 0.1 2017年10月18日 下午3:32:54 lw.xu Exp $
 */
public class CacheConfig {
    ...
    /** 缓存存储路径 */
    private String  persistecePath     = File.separatorChar + "tmp" + File.separatorChar + "prepayment-cache";
